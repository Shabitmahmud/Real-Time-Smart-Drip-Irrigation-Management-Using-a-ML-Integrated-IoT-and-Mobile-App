...
class _SoilMoistureScreenState extends State<SoilMoistureScreen> {
  ...
  void initState() {
    super.initState();
    fetchData('http://127.0.0.1:8000/soil_moisture_last_15_values/?field_id=f2'); // Fetch default data for field_id = 'f2'
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Soil Moisture Graph (Field 2)'),
        actions: [
          IconButton(
            ...
            onPressed: () {
              if (selectedCondition == "Last 15 Values") {
                fetchData(
                    'http://127.0.0.1:8000/soil_moisture_last_15_values/?field_id=f2');
              } else if (selectedCondition == "Last 7 Days Avg") {
                fetchData(
                    'http://127.0.0.1:8000/soil_moisture_last_7_days_avg/?field_id=f2');
              } else if (selectedCondition == "Last 15 Days Avg") {
                fetchData(
                    'http://127.0.0.1:8000/soil_moisture_last_15_days_avg/?field_id=f2');
              }
            },
          ),
        ],
