...
class _VolumeScreenState extends State<VolumeScreen> {
  ...
  void initState() {
    super.initState();
    fetchData('http://127.0.0.1:8000/volume_last_15_values/?field_id=f1'); // Fetch default data
  }
          ...
          IconButton(
            ...
            onPressed: () {
              if (selectedCondition == "Last 15 Values") {
                fetchData(
                    'http://127.0.0.1:8000/volume_last_15_values/?field_id=f1');
              } else if (selectedCondition == "Last 7 Days Avg") {
                fetchData(
                    'http://127.0.0.1:8000/volume_last_7_days_avg/?field_id=f1');
              } else if (selectedCondition == "Last 15 Days Avg") {
                fetchData(
                    'http://127.0.0.1:8000/volume_last_15_days_avg/?field_id=f1');
              }
            },
          ),
        ],
