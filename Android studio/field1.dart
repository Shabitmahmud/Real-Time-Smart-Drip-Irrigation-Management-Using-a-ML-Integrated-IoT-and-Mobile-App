...
import 'screens/soil_moisture_screen.dart';
import 'screens/flow_rate_screen.dart';
import 'screens/volume_screen.dart';
import 'help_screen.dart';  // Import the new HelpScreen

class Field1Screen extends StatefulWidget {
  @override
  _Field1ScreenState createState() => _Field1ScreenState();
}

class _Field1ScreenState extends State<Field1Screen> {
  double? temperature;
  double? humidity;
  double? soilMoisture;
  double? flowRate;
  ...
  Future<void> fetchData() async {
    final response = await http.get(Uri.parse('http://localhost:8000/field_info/latest?field_id=f1'));
  ...
  Future<void> updateAutomaticControl(String status) async {
    final response = await http.post(
      ...
      body: jsonEncode({'field_id': 'f1', 'status': status}),
    );
